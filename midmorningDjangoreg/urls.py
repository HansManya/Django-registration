"""midmorningDjangoreg URL Configuration
...
urlpatterns = [
    ...
    path('add_product/', general_views.add_product, name='add_product'),
    path('products/', general_views.view_products, name='products'),
    path('add_supplier/', general_views.add_supplier, name='add_supplier'),
    path('delete-product/<id>', general_views.delete_product, name='delete-product'),
    path('update_product/<id>', general_views.update_product, name='update_product'),
